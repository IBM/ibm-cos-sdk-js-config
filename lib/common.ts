 ...
 * ibm-cos-sdk-js-config/0.0.1 (lang=node.js; os.name=Linux; os.version=19.3.0; node.version=v10.15.3)
 *
 * In the example above, the analytics tool will parse the user-agent header and
 * use the following properties:
 * "ibm-cos-sdk-js-config" - the name of your sdk
...
export function getSdkHeaders(
  ...
  const sdkName = 'ibm-cos-sdk-js-config';
